    ...
    <header class="header" id="header">
      ...
      <div class="top-nav">
        <div class="container d-flex">
          <p>Order Online Or Call Us: 0932-345-0000</p>
          <ul class="d-flex">
      ...
      <div class="navigation">
        ...
        <a href="/" class="logo"><h1>Korean Coast</h1></a>
            ...
            <li class="glide__slide">
              <div class="center">
                <div class="left">
                  ...
                  <p>Trending from Korean fashion style collection</p>
                  <a href="#" class="hero-btn">SHOP NOW</a>
                </div>
                <div class="right">
                    <img class="img1" src="./images/hero-3.jpg" alt="">
                </div>
              </div>
            </li>
            <li class="glide__slide">
              <div class="center">
                ...
                <div class="right">
                  <img class="img2" src="./images/hero-4.jpg" alt="">
                </div>
              </div>
            </li>
          </ul>
    ...
    <section class="section contact">
      <div class="row">
        <div class="col">
          ...
          <p>We have a deep appreciation for our clients, and we are available around the clock to assist them. Our commitment to being at your service 24/7 underscores our dedication to customer satisfaction.</p>
    ...
    <div class="popup-content">
      ...
      <div class="popup-left">
        <div class="popup-img-container">
          <img class="popup-img" src="./images/popup2.jpg" alt="popup">
        </div>
      </div>
      <div class="popup-right">
        <div class="right-content">
          <h1>Get Discount <span>50%</span> Off</h1>
          <p>Subscribe to our newsletter and enjoy a 30% discount on your upcoming purchase. Rest assured, we guarantee a spam-free experience!
          </p>
          <form action="#">
